    ...
    int main()
    {
        int numberSurveyed// no semicolon
        int forJoe;
        int forDonald;
        ...
        cin >> forJo; //incorrect spelling of declared variable
        cout < < "How many of them say they will vote for Donald? "; // space between the less than signs
        cin >> forDonald;
